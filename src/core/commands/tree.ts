...
export function cloneTopicBranch(
  ...
  function cloneRecursive(topicId: TopicId, parentNewId: TopicId | null): TopicId {
    ...
    const cloned: Topic = {
      ...
      webLink: original.webLink ? { ...original.webLink } : undefined,
      cloudLink: original.cloudLink ? { ...original.cloudLink } : undefined,
      topicLink: original.topicLink ? { ...original.topicLink } : undefined,
      equation: original.equation ? { ...original.equation } : undefined,
